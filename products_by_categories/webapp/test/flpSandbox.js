		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#productsbycategories-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"productsbycategories-display": {
								"semanticObject": "productsbycategories",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=productsbycategories",
									"url": sap.ui.require.toUrl("productsbycategories")
								}
							}
						}
					}
